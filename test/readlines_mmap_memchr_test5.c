...
void test_readlines_mmap_memchr_correctness(void)
{
    ...
    assert(readlines_mmap_memchr(fp, &fbuf));
...
TEST_LIST = {
    { "test_readlines_mmap_memchr_correctness", test_readlines_mmap_memchr_correctness },
    { nullptr, nullptr },
};
