...
void test_readlines_mmap_getline_correctness(void)
{
    ...
    assert(readlines_mmap_getline(fp, &fbuf));
...
TEST_LIST = {
    { "test_readlines_mmap_getline_correctness", test_readlines_mmap_getline_correctness },
    { nullptr, nullptr },
};
